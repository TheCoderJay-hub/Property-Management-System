...
function Contact() {
 ...
 const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "b78ef3a4-29ea-45f1-bdc9-1d8195caac4a");
  ...
  return (
    ...
    viewport={{once:true}}
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden bg-gray-800' id = 'Contact'>
       <h1 className='text-2xl sm:text-4xl font-bold text-white mb-2 text-center'>Contact <span className='underline underline-offset-4 decoration-1 under font-light'>With Us</span></h1>
